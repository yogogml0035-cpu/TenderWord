...
from backend.nodes.skills_nodes.edit_nodes import (
    dispatch_edit_delete_section,
    dispatch_edit_update_word,
    edit_text,
...
def get_workflow() -> TaskSkillWorkflow:
    return TaskSkillWorkflow(
        ...
        nodes=(
            ...
            TaskSkillWorkflowNode("delete_section", dispatch_edit_delete_section),
            TaskSkillWorkflowNode("edit_text", edit_text),
            TaskSkillWorkflowNode("update_word", dispatch_edit_update_word),
        ),
        edges=(
