...
if __name__ == "__main__":
    ...
    from util.word_util import create_word_application, close_word_application, open_document_with_retry
    from util.word_util import wdGoToPage, wdGoToAbsolute
